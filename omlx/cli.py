...
""",
    ...
    serve_parser.add_argument(
        ...
        "completion_batch_size). Defaults to --max-concurrent-requests for "
        "back-compat. Set this BELOW --max-concurrent-requests to decouple "
        "HTTP admission from GPU-layer batch fusion: requests still queue "
        "at the HTTP layer while each Metal command buffer encodes at most "
