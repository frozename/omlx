...
def test_apply_args_parses_cli_pairs(tmp_path):
...
def test_apply_args_ignores_empty_and_whitespace_pairs(tmp_path):
    from omlx.settings import GlobalSettings
...
def test_to_scheduler_config_propagates_per_model_dict(tmp_path):
    from omlx.settings import GlobalSettings
