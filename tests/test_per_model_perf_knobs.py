...
def test_apply_args_parses_completion_batch_size_pairs():
...
def test_apply_args_parses_prefill_step_size_pairs():
    from omlx.settings import Settings
...
def test_to_scheduler_config_propagates_per_model_dicts():
    from omlx.settings import Settings
